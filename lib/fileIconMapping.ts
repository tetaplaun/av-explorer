...
const extensionMappings: Record<string, IconMapping> = {
  ...
  // Java/JVM
  '.java': { icon: SiJava, color: 'text-red-600' },
  '.class': { icon: SiJava, color: 'text-red-500' },
  '.jar': { icon: SiJava, color: 'text-red-600' },
  ...
  // C#/.NET
  '.cs': { icon: SiCsharp, color: 'text-purple-700' },
  ...
  '.bash': { icon: SiBash, color: 'text-gray-600' },
  '.zsh': { icon: FaTerminal, color: 'text-gray-600' },
  '.fish': { icon: FaTerminal, color: 'text-gray-600' },
  '.ps1': { icon: SiPowershell, color: 'text-blue-600' },
  '.psm1': { icon: SiPowershell, color: 'text-blue-600' },
  '.psd1': { icon: SiPowershell, color: 'text-blue-600' },
  ...
  '.appx': { icon: SiWindows, color: 'text-blue-600' },
  '.appxbundle': { icon: SiWindows, color: 'text-blue-600' },
  ...
  '.fs': { icon: VscFileCode, color: 'text-blue-600' },
...
export const filePatterns: FileIconPattern[] = [
  ...
  { pattern: /^rollup\.config/i, icon: SiRollup, color: 'text-red-600' },
  ...
  // Editor configs
  { pattern: /^\.vscode/i, icon: SiVisualstudiocode, color: 'text-blue-600' },
